$(document).ready(function () {
    ...
    function tableCreate(data) {
        ...
        th1.appendChild(document.createTextNode('Severity'));
        ...
        for (let i = 0; i < nr_iterations; i++) {
            ...
            td.appendChild(document.createTextNode(dataArray[i]["type"]));

            let td1 = document.createElement('td');
            td1.appendChild(document.createTextNode(dataArray[i]["severity"]));
    ...
    function getData(start, end) {
        ...
        $.post("/Main/GetAllReports", { start: start, end: end },
